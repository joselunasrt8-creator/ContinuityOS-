...
This audit adds only this artifact:

- `governance/operational-risk/OPERATIONAL_RISK_AUDIT_2031.md`

Referenced evidence surfaces are read-only for this audit.
...
- Repository status should show only this artifact as a new/modified file before
  commit.
